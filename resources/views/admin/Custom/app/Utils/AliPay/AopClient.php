...
class AopClient
{
    ...
    /*
        ...
        auther:笙默
    */
    public function pageExecute($request, $returnUrl, $notifyUrl, $httpmethod = "POST")
    {
        \Log::LogWirte('request:' . json_encode($request), 'pageExecute');
        $this->setupCharsets($request);
        ...
        $sysParams["notify_url"] = $notifyUrl;
        $sysParams["return_url"] = $returnUrl;
        $sysParams["charset"] = $this->postCharset;
        //dump($sysParams);die;
        \Log::LogWirte('request:' . json_encode($sysParams), 'pageExecute');
        //获取业务参数
