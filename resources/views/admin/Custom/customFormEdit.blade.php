...
<div id="container" class="position">
    ...
    <div id="bd">
        <div id="main">
            <form action="{{url('customFormEdit')}}" method="post" style="width: 100%; float: left"
                ...
                <div class="search-area">
                    <div class="kv-item ue-clear">
                        <label>账号:</label>
                        <div class="kv-item-content">
                            <input type="text" style="width: 100px;height: 28px;" name="username" id="price"
                                   value="{{$info -> username}}"/>
                        </div>
                    </div>
                </div>
