...
class CreditPayment
{
    ...
    static function agreementSignConfirm()
    {
        /** 请求接口的业务数据信息 **/
        $bizData = [];
        $bizData["outTradeNo"] = "5cf627d077f8b";//签约请求和签约确认的商户订单号传相同值  //5cf6229762d04
        $bizData["agreementNo"] = "2019060420653938158";
        $bizData["inCustomerNo"] = Constants::CUSTOMER_NO;
        $bizData["verifyCode"] = "555193";
    ...
    static function agreementPay()
    {
        /** 请求接口的业务数据信息 **/
        $bizData = [];
        $bizData["agreementNo"] = "2019060420653938158";//签约请求接口返回的协议号
        $bizData["payTool"] = "COLL";
        $bizData["outTradeNo"] = "5cf627d077f8b";//签约请求和签约确认的商户订单号传相同值
