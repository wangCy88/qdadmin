...
<div id="container" class="position">
    ...
    <div id="bd">
        <div id="main">
            <form action="{{url('addCardTicket')}}" method="post" style="width: 100%; float: left"
                ...
                <div class="search-area">
                    <div class="kv-item ue-clear">
                        ...
                        <div class="kv-item-content">
                            <input type="text" style="width: 100px;height: 28px;" name="face_value" value=""/>
                        </div>
                    </div>
                </div>
                ...
                <div class="search-area">
                    <div class="kv-item ue-clear">
                        <label>价格:</label>
                        <div class="kv-item-content">
                            <input type="text" style="width: 100px;height: 28px;" name="price" id="price" value=""/>
                        </div>
                    </div>
                </div>
                ...
                <div class="search-area">
                    <div class="kv-item ue-clear">
                        <label>折扣:</label>
                        <div class="kv-item-content">
                            <input type="text" style="width: 100px;height: 28px;" name="rebate" id="rebate"
                                   value="100"/>
                        </div>
                    </div>
                </div>
