...
<div id="container" class="position">
    ...
    <div id="bd">
        <div id="main">
            <form action="{{url('updateCardTicket')}}" method="post" style="width: 100%; float: left"
                  enctype="multipart/form-data">
                <input style="display: none" type="text" name="id" value="{{$info -> id}}">
                <div class="search-area">
                    <div class="kv-item ue-clear">
                        <label>面值:</label>
                        <div class="kv-item-content">
                            <input type="text" style="width: 100px;height: 28px;" name="face_value"
